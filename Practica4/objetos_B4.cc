...
{
	//Vector ambiente difusa
	v_ambiente_difusa.resize(4);
	v_ambiente_difusa[0]._0 = 0.62352;
	v_ambiente_difusa[0]._1 = 0.372549;
	v_ambiente_difusa[0]._2 = 0.62352;

	v_ambiente_difusa[1]._0 = 0.439216;
	v_ambiente_difusa[1]._1 = 0.858824;
	v_ambiente_difusa[1]._2 = 0.576471;

	v_ambiente_difusa[2]._0 = 1.0;
	v_ambiente_difusa[2]._1 = 0.498039;
	v_ambiente_difusa[2]._2 = 0.0;

	v_ambiente_difusa[3]._0 = 0.8;
	v_ambiente_difusa[3]._1 = 0.196078;
	v_ambiente_difusa[3]._2 = 0.6;
	//Vector especular
	v_especular.resize(4);
	v_especular[0]._0 = 0.3;
	v_especular[0]._1 = 0.1;
	v_especular[0]._2 = 0.1;

	v_especular[1]._0 = 0.2;
	v_especular[1]._1 = 0.2;
	v_especular[1]._2 = 0.2;

	v_especular[2]._0 = 0.8;
	v_especular[2]._1 = 0.0;
	v_especular[2]._2 = 0.8;

	v_especular[3]._0 = 0.4;
	v_especular[3]._1 = 0.1;
	v_especular[3]._2 = 0.0;

	b_normales_caras = false;
	b_normales_vertices = false;
	ambiente_difusa._0 = v_ambiente_difusa[0]._0;
	ambiente_difusa._1 = v_ambiente_difusa[0]._1;
	ambiente_difusa._2 = v_ambiente_difusa[0]._2;
	especular._0 = v_especular[0]._0;
	especular._1 = v_especular[0]._1;
	especular._2 = v_especular[0]._2;
	brillo = 60.0;
}

void _triangulos3D::cambio_materiales(int num)
{
	if(num>3){
		ambiente_difusa._0 = v_ambiente_difusa[0]._0;
		ambiente_difusa._1 = v_ambiente_difusa[0]._1;
		...
		ambiente_difusa._0 = v_ambiente_difusa[num]._0;
		ambiente_difusa._1 = v_ambiente_difusa[num]._1;
		ambiente_difusa._2 = v_ambiente_difusa[num]._2;
		especular._0 = v_especular[num]._0;
		especular._1 = v_especular[num]._1;
		especular._2 = v_especular[num]._2;
	}
}
...
void _triangulos3D::draw_iluminacion_plana( )
{
	...
	//Aqui se supone que va algo comentado
...
void _triangulos3D::calcular_normales_vertices()
{
	if (!b_normales_vertices){
		...
		for (unsigned int i= 0; i < vertices.size() ; i++){
			normales_vertices[i] =_vertex3f(0,0,0);
		}
		...
		for (unsigned int i= 0; i < normales_vertices.size() ; i++){
			_vertex3f n = normales_vertices[i];
			float m=sqrt(n.x*n.x+n.y*n.y+n.z*n.z);
